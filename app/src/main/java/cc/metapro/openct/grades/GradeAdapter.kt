...
@Keep
internal class GradeAdapter(context: Context) : RecyclerView.Adapter<GradeAdapter.GradeViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): GradeViewHolder {
        val view = mInflater.inflate(R.layout.item_grade, parent, false)
